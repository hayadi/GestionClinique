...
describe('Service Tests', () => {
    describe('Clinique Service', () => {
        ...
        beforeEach(() => {
            ...
            expectedResult = {};
            injector = getTestBed();
            service = injector.get(CliniqueService);
            httpMock = injector.get(HttpTestingController);

            elemDefault = new Clinique(0, 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 'AAAAAAA');
        });
