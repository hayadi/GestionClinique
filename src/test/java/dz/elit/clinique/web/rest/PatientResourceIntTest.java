...
import static dz.elit.clinique.web.rest.TestUtil.createFormattingConversionService;
...
public class PatientResourceIntTest {
    ...
    public void createPatient() throws Exception {
        ...
        assertThat(testPatient.getFax()).isEqualTo(DEFAULT_FAX);
    ...
    public void updatePatient() throws Exception {
        ...
        assertThat(testPatient.getFax()).isEqualTo(UPDATED_FAX);
