...
/**
 * REST controller for managing {@link dz.elit.clinique.domain.Specialite}.
 */
@RestController
@RequestMapping("/api")
public class SpecialiteResource {
    ...
    public ResponseEntity<Specialite> updateSpecialite(@RequestBody Specialite specialite) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, specialite.getId().toString()))
            .body(result);
    }
